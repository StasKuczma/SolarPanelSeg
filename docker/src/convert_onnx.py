...
def export_to_onnx(model_path, output_path, input_size=(3, 256, 256), device="cuda"):
    """
    ...
    dummy_input = torch.randn(1, *input_size).to(device)  # Batch size 1, RGB image
...
output_path = "solar_panel_segmentation.onnx"  # Path to save the ONNX file
